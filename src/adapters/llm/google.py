...
class GoogleProvider(BaseLLMProvider):
    ...
    Supports Gemini models using the new google.genai Client API.
    ...
    def complete(
        ...
        **kwargs
        ...
        """Generate a completion using new client.models.generate_content() API."""
    ...
    def stream(
        ...
        **kwargs
        ...
        """Stream a completion using new API."""
        if self._client is None:
            self.initialize()
